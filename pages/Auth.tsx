...
const Auth: React.FC<AuthProps> = ({ onBack, onGenerateID, onEmailLogin, onGoogleLogin }) => {
  const { t } = useUser();
  return (
      ...
      <div className="flex-1 flex flex-col px-5 pb-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Google sign-in is hidden until the OAuth provider is configured in Supabase. */}
          </div>
        </div>
